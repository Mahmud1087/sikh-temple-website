const EducationalFund: React.FC = () => (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        {/* Aim Section */}
        <div>
          <h2 className="text-2xl font-semibold text-blue-500 mb-4">Our Aim</h2>
        ...
        {/* Awards Section */}
        <div>
          <h2 className="text-2xl font-semibold text-blue-500 mb-4">Awards</h2>
          <ul className="list-disc list-inside text-lg text-gray-700 space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-blue-500 mb-4">Scholarships</h2>
          <ul className="list-disc list-inside text-lg text-gray-700 space-y-2">
        ...
        {/* Bursaries Section */}
        <div>
          <h2 className="text-2xl font-semibold text-blue-500 mb-4">Bursaries</h2>
          <ul className="list-disc list-inside text-lg text-gray-700 space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-blue-500 mb-4">Breaking News</h2>
          <p className="text-lg text-gray-700">
      ...
      {/* Gallery Section */}
      <div className="mt-8">
        <h2 className="text-2xl font-semibold text-blue-500 mb-4">Gallery</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-gray-200 h-40 rounded shadow-sm flex items-center justify-center">Image Placeholder</div>
          <div className="bg-gray-200 h-40 rounded shadow-sm flex items-center justify-center">Image Placeholder</div>
          <div className="bg-gray-200 h-40 rounded shadow-sm flex items-center justify-center">Image Placeholder</div>
        </div>
      </div>
