      ...
      <footer className="bg-black text-white py-8 mt-10">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 mb-4 md:mb-0">
            <a href="/about" className="text-orange-600 hover:text-orange-400" aria-label="About Us">
              About Us
            </a>
            <a href="/events" className="text-orange-600 hover:text-orange-400" aria-label="Events">
              Events
            </a>
            <a href="/contact" className="text-orange-600 hover:text-orange-400" aria-label="Contact">
              Contact
            </a>
          </div>
